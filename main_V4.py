...
########################################################################################################################
# ezeknek a parametereknek valtoztasd meg az erteket:
#   num_of_vehicles
#   num_of_cities
#   num_of_iterations (nem feltetlenul kell valtoztatni, maradhat 1000)

run = RunResults(num_of_vehicles=5, num_of_cities=20, num_of_iterations=1000)
run.iter_pop()
run.best_sol()
run.print_cost()